...
OUTPUT_PATH2='/home/cesar/Desktop/luisd/scripts/Graficas_desvanecimientos/Input_data/Data_binary/'
CONVERTER='/opt/Septentrio/RxTools/bin/bin2asc'

FOLDERS=`diff -q ${INPUT_PATH} ${OUTPUT_PATH2} | grep Only | grep ${INPUT_PATH} | awk '{print $4}'`
